...
export class DataService {
  ...
  // Dog Park Management
  addDogPark(park: Omit<DogPark, 'id'>): DogPark {
  ...
  addWasteDispenser(dispenser: Omit<WasteDispenser, 'id'>): WasteDispenser {
  ...
  deleteWasteDispenser(id: number): void {
