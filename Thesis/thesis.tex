...
\newcolumntype{Y}{>{\raggedright\arraybackslash\hyphenpenalty=0\exhyphenpenalty=0}X}
...
\begin{titlepage}
  ...
  \begin{tabular}{ll}
    ...
    \textbf{Schuljahr:}  & 2026/27 \\[0.3cm]
    \textbf{Abgabedatum:} & 18.09.2026 \\
  \end{tabular}
...
\input{chapters/02_anforderungen}
\input{chapters/03_architektur}
\input{chapters/04_technologie}
\input{chapters/05_backend}
\input{chapters/06_ios}
\input{chapters/07_testing}
\input{chapters/08_zusammenfassung}
...
%% -------------------------------------------------------
\appendix
\input{appendix/api_spec}
\input{appendix/prompts_ki}
