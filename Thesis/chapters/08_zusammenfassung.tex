...
redundanten Foreign-Key \texttt{LegalRestrictionsId1} in der \texttt{Breeds}-Tabelle.
...
\paragraph{Fehlendes Controller-Layer}
Das Backend wurde zunächst ohne dedizierte Controller-Klassen begonnen; Endpunkte wurden
direkt in \texttt{Program.cs} als Minimal~API definiert. Erst im Verlauf des Projekts
wurde auf den klassischen Controller-Ansatz umgestellt, was zu einer Umstrukturierung
