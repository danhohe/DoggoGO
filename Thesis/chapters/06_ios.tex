...
\begin{lstlisting}[language=swift, caption={Kartenansicht in SwiftUI (vereinfacht)}, label=lst:mapview, float=htbp]
import SwiftUI
import MapKit
...
\begin{lstlisting}[language=swift, caption={LocationManager (Auszug)}, label=lst:locationmanager, float=htbp]
...
\begin{lstlisting}[language=swift, caption={Login-Anfrage (Auszug)}, label=lst:login, float=htbp]
...
\begin{lstlisting}[language=swift, caption={AuthService – Keychain-Speicherung (Auszug)}, label=lst:keychain, float=htbp]
class AuthService {
...
\begin{lstlisting}[language=swift, caption={DogListView – Übersicht der Hundeprofile (Auszug)}, label=lst:doglist, float=htbp]
...
\begin{lstlisting}[language=swift, caption={LegalRestrictionsView – Anzeige der Vorschriften}, label=lst:legal, float=htbp]
...
\begin{lstlisting}[language=swift, caption={APIService – Authentifizierter Request (Auszug)}, label=lst:apiservice, float=htbp]
